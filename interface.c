...
void contruction_interface(int argc, char *argv[]){
	  ...
	  gtk_widget_set_size_request(main_window, 800, 300);
	  ...
	  vue2 = GTK_TEXT_VIEW (gtk_builder_get_object (builder, "textview1"));
	  vue3 = GTK_TEXT_VIEW (gtk_builder_get_object (builder, "textview1"));
